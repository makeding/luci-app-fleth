    [0x240d00100c] = {219, 105, 140},
    [0x240d001010] = {219, 105, 144},
    [0x240d001014] = {219, 105, 148},
    [0x240d001018] = {219, 105, 152},
    [0x240d00101c] = {219, 105, 156}
...
local function calc(prefix)
    ...
    local hextet = {}
    for i = 1, 4 do
        hextet[i] = tonumber(field[i] or "0", 16)
    end
    ...
    local octet, peeraddr, ipaddr, ip6prefixlen, psidlen, offset, provider

    -- https://github.com/site-u2023/config-software/blob/796e19856b162788776dd5d461bb50ed82750c05/map-e.sh#L826
    -- https://note.com/computerlanglab/n/n840695144f6b
    if hextet[1] == 0x240b then
        peeraddr = "2404:9200:225:100::64"
        provider = "JPNE（v6プラス）"
    elseif hextet[1] == 0x2404 then
        if hextet[2] >= 0x7a80 and hextet[2] < 0x7a84 then
            provider = "BIGLOBE（東日本）"
    ...
    elseif hextet[1] == 0x2400 then
        ...
        provider = "OCN"
    elseif hextet[1] == 0x240d then
        peeraddr = "2001:3b8:200:ff9::1"
        provider = "NURO"
    end
    if ruleprefix38[prefix38] then
        octet = {unpack(ruleprefix38[prefix38])}
        octet[3] = bor(octet[3], rshift(band(hextet[3], 0x0300), 8))
        octet[4] = band(hextet[3], 0x00ff)
        ipaddr = {unpack(ruleprefix38[prefix38])}
        table.insert(ipaddr, 0)
        ip6prefixlen = 38
        psidlen = 8
        offset = 4
    elseif ruleprefix31[prefix31] then
        octet = {unpack(ruleprefix31[prefix31])}
        octet[2] = bor(octet[2], band(hextet[2], 0x0001))
        octet[3] = rshift(band(hextet[3], 0xff00), 8)
        octet[4] = band(hextet[3], 0x00ff)
        ipaddr = {unpack(ruleprefix31[prefix31])}
        table.insert(ipaddr, 0)
        table.insert(ipaddr, 0)
        ip6prefixlen = 31
        psidlen = 8
        offset = 4
    elseif ruleprefix38_20[prefix38] then
        octet = {unpack(ruleprefix38_20[prefix38])}
        octet[3] = bor(octet[3], rshift(band(hextet[3], 0x03c0), 6))
        octet[4] = bor(lshift(band(hextet[3], 0x003f), 2), rshift(band(hextet[4], 0xc000), 14))
        ipaddr = {unpack(ruleprefix38_20[prefix38])}
        table.insert(ipaddr, 0)
        ip6prefixlen = 38
        psidlen = 6
    else
    ...
    local psid
    if psidlen == 8 then
        psid = rshift(band(hextet[4], 0xff00), 8)
    elseif psidlen == 6 then
        psid = rshift(band(hextet[4], 0x3f00), 8)
    end
    ...
    if ip6prefixlen == 38 then
        hextet2[1] = string.format("%x",hextet[1])
        hextet2[2] = string.format("%x",hextet[2])
        hextet2[3] = string.format("%x",bitwise_and(hextet[3], 0xfc00))
    elseif ip6prefixlen == 31 then
        hextet2[1] = string.format("%x",hextet[1])
        hextet2[2] = string.format("%x",bitwise_and(hextet[2], 0xfffe))
    end
    

    local ip6prefix = table.concat(hextet2, ":") .. "::"
    ...
    print(provider)
    -- ipaddr
    print(table.concat(octet, "."))

    print(peeraddr)
    -- IPv4 prefix
    print(table.concat(ipaddr, "."))
...
local function main(args)
    if #args < 2 or args[1] ~= "calc" then
        print("Usage: lua map.lua calc <ipv6_prefix>")
        return
    end
